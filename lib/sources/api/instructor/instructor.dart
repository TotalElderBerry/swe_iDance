...
class InstructorAPI {
  ...
  static Future<InstructorModel> getInstructor(String id) async {
    ...
    if (response.statusCode == 200) {
      InstructorModel instructor =
          InstructorModel.fromJson(jsonDecode(response.body));
      return instructor;
    } else {
  ...
  static Future<List<dynamic>> getLiveClassesOfInstructorbyId(
      int instructor_id) async {
    print(instructor_id);
  ...
  static Future<dynamic> getRecordedDanceClassesOfInstructor(
  ...
  static Future<dynamic> acceptStudentDanceBooking(
      int student_id, int dance_class_id) async {
  ...
  static Future<dynamic> rejectCancellationRequest(
      int student_id, int dance_class_id) async {
